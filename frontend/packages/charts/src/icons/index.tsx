...
export const MoreVerticalIcon: React.FC<IconProps> = ({ className, size = 16 }) => (
  <svg
    className={className}
    fill="none"
    height={size}
...
export const ZoomInIcon: React.FC<IconProps> = ({ className, size = 16 }) => (
  <svg
    className={className}
    fill="none"
    height={size}
...
export const ZoomOutIcon: React.FC<IconProps> = ({ className, size = 16 }) => (
  <svg
    className={className}
    fill="none"
    height={size}
