    ...
    <div className="cc-category">
      ...
      <div className="cc-category__header">
        <div className="cc-category__info">
          <div
            className={`cc-category__icon ${category.required ? "cc-category__icon--required" : enabled ? "cc-category__icon--enabled" : ""}`}
          >
            {category.required ? (
            ...
            {category.cookies!.map((cookie, index) => (
              ...
              >
                <div className="cc-cookie-item__header">
                  ...
                  <span className="cc-cookie-item__expiry">
                    {cookie.expiry}
                  </span>
                </div>
                <p className="cc-cookie-item__purpose">
                  <span className="cc-cookie-item__provider">
                    {cookie.provider}:
                  </span>{" "}
                  {cookie.purpose}
                </p>
