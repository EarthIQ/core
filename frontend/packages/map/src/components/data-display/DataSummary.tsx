...
export const DataSummary: React.FC<DataSummaryProps> = ({
  ...
  const formatValue = useCallback(
    (field: DataSummaryField, value: any): string => {
        ...
        <>
          ...
          <div
            style={{
              ...
              gridTemplateColumns:
                layout === "grid" ? "repeat(2, 1fr)" : undefined,
            ...
            {fields.map((field) => (
              <div
                ...
                style={{
                  ...
                  justifyContent:
                    layout === "horizontal" ? "center" : "space-between",
              ...
              >
                ...
                <span
                  style={{
                    fontWeight: 600,
                    fontSize:
                      variant === "compact" ? 12 : variant === "card" ? 16 : 13,
                    color: "#333",
                  }}
                >
