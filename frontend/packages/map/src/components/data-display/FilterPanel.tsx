...
export interface FilterDefinition {
  ...
  /** Filter type */
  type:
    "text" | "number" | "select" | "multiselect" | "range" | "date" | "boolean";
...
const FilterInput: React.FC<FilterInputProps> = ({
  ...
  const handleChange = (
    newValue: any,
    newOperator?: FilterState[string]["operator"]
  ) => {
      ...
      {type === "range" && (
        <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
          <Input
            ...
            value={value?.[0] ?? ""}
            onChange={(e) =>
              handleChange([parseFloat(e.target.value), value?.[1]], "between")
            }
          />
          <span>-</span>
          <Input
            ...
            value={value?.[1] ?? ""}
            onChange={(e) =>
              handleChange([value?.[0], parseFloat(e.target.value)], "between")
            }
          />
        </div>
      )}
      ...
      {type === "date" && (
        <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
          <Input
            ...
            value={value?.[0] || ""}
            onChange={(e) =>
              handleChange([e.target.value, value?.[1]], "between")
            }
          />
          <span>-</span>
          <Input
            ...
            value={value?.[1] || ""}
            onChange={(e) =>
              handleChange([value?.[0], e.target.value], "between")
            }
          />
        </div>
      )}
